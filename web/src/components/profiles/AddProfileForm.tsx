...
import { Mail, ArrowLeft, Loader2, User, ShieldCheck, Info } from "lucide-react";
...
const AddProfileForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-8">
      <div className="mb-8">
         <h1 className="text-3xl font-bold text-foreground tracking-tight mb-1">Add New Profile</h1>
         <p className="text-foreground/40 text-sm font-medium">Provision a new user account by entering their primary email address.</p>
      </div>
      ...
      <div className="card-meltwater p-8 space-y-8">
        <div className="space-y-6">
          <div className="flex items-center gap-3 mb-2">
             ...
             <h2 className="text-lg font-bold text-foreground tracking-tight">User Identity</h2>
          </div>
          
          <div className="space-y-4">
            <div className="space-y-2">
              <label htmlFor="email" className="text-[10px] font-bold text-foreground/30 uppercase tracking-widest px-1">
            ...
            <div className="p-4 rounded-xl bg-primary/5 border border-primary/10 flex items-start gap-3">
               ...
               <p className="text-[11px] font-medium text-foreground/60 leading-relaxed">
                  The user will receive an automated invitation email to verify their account and set their password once the profile is created.
               </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6 pt-8 border-t border-border">
          <div className="flex items-center gap-3 mb-2">
             ...
             <h2 className="text-lg font-bold text-foreground tracking-tight">Access Permissions</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
             <div className="p-4 rounded-xl border border-primary/20 bg-primary/5 relative overflow-hidden group">
                ...
                <p className="text-xs font-bold text-foreground mb-1">Standard User</p>
                <p className="text-[10px] font-medium text-foreground/40">Default access level for new profiles.</p>
             </div>
             <div className="p-4 rounded-xl border border-border bg-foreground/[0.02] opacity-50 grayscale cursor-not-allowed">
                <p className="text-xs font-bold text-foreground mb-1">Administrative Access</p>
                <p className="text-[10px] font-medium text-foreground/40">Requires elevated verification.</p>
             </div>
          </div>
        </div>
      </div>
