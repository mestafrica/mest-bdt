...
import { Image as ImageIcon, Calendar, Info, Loader2 } from "lucide-react"; // Removed unused imports: Layout, ArrowLeft
    ...
    >
      <div className="mb-8">
        ...
        <p className="text-foreground/40 text-sm font-medium">
          Update the program information and settings below.
        </p>
      </div>
      ...
      <div className="flex items-center justify-end gap-4 pt-4">
        ...
        <SubmitButton title="Update Program" className="px-10 py-3 text-base" />
      </div>
    </form>
  );
}
