  ...
  return (
    <div className="card-meltwater p-8 w-full border-primary/5">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h2 className="text-xl font-bold text-foreground tracking-tight">Mission and Goals</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-2">
             ...
             <h3 className="text-[10px] font-bold text-foreground/30 uppercase tracking-widest">Expectations & Outcomes</h3>
          </div>
