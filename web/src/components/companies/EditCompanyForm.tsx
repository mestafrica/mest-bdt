    ...
    >
      <div className="mb-8">
         <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl font-bold text-foreground tracking-tight">Edit Company</h1>
         </div>
         <p className="text-foreground/40 text-sm mt-1 font-medium">Update organization settings and contact information.</p>
      </div>
