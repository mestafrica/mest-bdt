...
import { Image as ImageIcon, Calendar, Info, Users, Loader2 } from "lucide-react";
...
export default function AddCohortForm() {
  ...
  return (
    ...
    >
      <div className="mb-8">
         <h1 className="text-3xl font-bold text-foreground tracking-tight">Add New Cohort</h1>
         <p className="text-foreground/40 text-sm mt-1 font-medium">Create a new student cohort by filling out the information below.</p>
      </div>
      ...
      <div className="card-meltwater p-8 space-y-8">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-3 mb-2">
             ...
             <h2 className="text-lg font-bold text-foreground tracking-tight">Cohort Details</h2>
          </div>
        ...
        <div className="space-y-6 pt-8 border-t border-border">
          <div className="flex items-center gap-3 mb-2">
             ...
             <h2 className="text-lg font-bold text-foreground tracking-tight">Duration</h2>
          </div>
        ...
        <div className="space-y-6 pt-8 border-t border-border">
          <div className="flex items-center gap-3 mb-2">
             ...
             <h2 className="text-lg font-bold text-foreground tracking-tight">Cohort Banner</h2>
          </div>
          ...
          <div className="relative">
             {loading ? (
                ...
                <div className="w-full p-6 flex flex-col items-center justify-center gap-4 bg-primary/5 rounded-2xl border border-primary/20 transition-all">
                   ...
                   <p className="text-xs font-bold text-primary uppercase tracking-widest">Image uploaded successfully</p>
                </div>
             ) : (
